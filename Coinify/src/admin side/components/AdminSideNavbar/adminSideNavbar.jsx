  ...
  return (
    <div className="adminSideNavbar">
      ...
      <div className="interdiv">
        ...
        <Link to="/adminHomepage"><div className="flexflex">
            <li>
              {" "}
          ...
          <Link to="/adminUserspage"><div className="flexflex">
            <li>
              <RiUserSettingsFill className="userslogo" /> Users{" "}
            </li>
          </div></Link>
          <div className="gold-line"></div>
          <Link to="/adminTransactionspage"> <div className="flexflex">
            <li>
              <GrTransaction className="transactionlogo" /> transactions{" "}
            </li>
          </div></Link>
          <div className="gold-line"></div>
          <Link to="/adminPromotionspage"> <div className="flexflex">
            <li>
