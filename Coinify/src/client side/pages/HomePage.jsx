      ...
      <div className="bottomside">
        <div className="card">
          <div className="main-content">
            ...
            <p className="heading">We make sure your money  will be safe 100% gurarantee</p>
        ...
        <div className="card">
          <div className="main-content">
            ...
            <p className="heading">Your Money will be sent faster  than your blue wallet</p>
            <div className="categories">
              <span>Fast</span>
              <span>Easy</span>
            </div>
        ...
        <div className="card">
          <div className="main-content">
            ...
            <p className="heading">Experience seamless and secure USDT transfers with our platform, ensuring fast and reliable transactions for your digital assets</p>
            <div className="categories">
              <span>Secure</span>
              <span>Trusted</span>
            </div>
